...
Original file is located at
    https://colab.research.google.com/gist/jeevanphrql/1e8bf19d124622fec2bf86836e8ffc24/python_quickstart.ipynb
...
#GOOGLE_API_KEY=userdata.get('AIzaSyDhHW5RqHlXSr19ejj-MjzsPupINOD9y9A')

genai.configure(api_key="AIzaSyDhHW5RqHlXSr19ejj-MjzsPupINOD9y9A")
...
image = PIL.Image.open('/content/IMG_0175.jpg')
...
image = PIL.Image.open('/content/unnamed.jpg')
